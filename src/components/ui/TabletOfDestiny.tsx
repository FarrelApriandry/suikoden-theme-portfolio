  ...
  return (
    <section className="grid gap-4 sm:grid-cols-2 xl:grid-cols-3">
      {mockProjects.map((project) => (
        <article
          key={project.title}
          className="flex h-full flex-col gap-3 rounded-xl border border-suikoden-border/70 bg-gradient-to-b from-zinc-900/90 to-zinc-950/90 p-4 text-slate-100 shadow-lg"
        >
