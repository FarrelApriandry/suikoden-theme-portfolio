...
const InnGuestbook = () => {
  return (
    <section className="w-full">
      <div className="grid grid-cols-1 md:grid-cols-[300px_1fr] lg:grid-cols-[350px_1fr] gap-6 w-full">
        ...
        <div className="rounded-xl border border-suikoden-border/70 bg-zinc-900/90 p-4 shadow-lg">
          ...
          <ScrollArea className="mt-3 h-[400px] min-h-[300px] rounded-md border border-suikoden-border/50 bg-zinc-950 p-4">
